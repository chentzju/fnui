...
define('fnui/fnuicore',['jquery'],function($){
...
define('fnui/dimmer',['jquery','./fnuicore'],function($,UI){
...
/*=============
 ALERT JS component
================*/
define('fnui/alert',['jquery','./fnuicore'],function($,UI){
...
define('fnui/button',['jquery','./fnuicore'],function($,UI){
...
define('fnui/collapse',['jquery','./fnuicore'],function($,UI){
...
/*=============
  FNUI 2.0 DATEPICKER
================*/
 define('fnui/datepicker',['jquery','./fnuicore'],function($,UI){
    ...
    var Datepicker = function(element, options) {
      ...
      this.component = this.$element.is('.fn-datepicker-date') ?
        this.$element.find('.fn-datepicker-add-on') : false;
    ...
    Datepicker.prototype.close = function() {
      ...
      this.showMode();
      if (!this.isInput) {
        $(document).off('mousedown.datapicker touchstart.datepicker',
          this.close);
      }
      // this.set();
      this.$element.trigger({
    ...
    Datepicker.prototype.fillDow = function() {
      ...
      while (dowCount < this.weekStart + 7) {
        // NOTE: do % then add 1
        html += '<th class="fn-datepicker-dow">' +
    ...
    Datepicker.prototype.fillMonths = function() {
      ...
      var i = 0;
      while (i < 12) {
        html += '<span class="fn-datepicker-month">' +
    ...
    Datepicker.prototype.fill = function() {
      ...
      var daysSelect = this.$picker
        .find('.fn-datepicker-days .fn-datepicker-select');
      ...
      while (prevMonth.valueOf() < nextMonth) {
        ...
        html.push('<td class="fn-datepicker-day ' +
      ...
      this.$picker.find('.fn-datepicker-days tbody')
        .empty().append(html.join(''));

      var currentYear = this.date.getFullYear();
      var months = this.$picker.find('.fn-datepicker-months')
        .find('.fn-datepicker-select')
        .text(year);
      months = months.end()
        .find('span').removeClass('fn-active').removeClass('fn-disabled');
      ...
      for (var i = -1; i < 11; i++) {
        ...
        (i === -1 || i === 10 ? 'fn-datepicker-old' : '') +
        (currentYear === year ? 'fn-active' : '') + '">' + year + '</span>';
        year += 1;
      }
      yearCont.html(html);
    };
            ...
            switch ($target[0].className) {
              ...
              case 'fn-datepicker-next':
                this.viewDate['set' + DPGlobal.modes[this.viewMode].navFnc].call(
                  ...
                  ($target[0].className === 'fn-datepicker-prev' ? -1 : 1)
                );
                this.fill();
                this.set();
                break;
    ...
    Datepicker.prototype.showMode = function(dir) {
      ...
      this.$picker.find('>div').hide().
        filter('.fn-datepicker-' + DPGlobal.modes[this.viewMode].clsName).show();
    };
    ...
    var DPGlobal = {
      ...
      headTemplate: '<thead>' +
      '<tr class="fn-datepicker-header">' +
      '<th class="fn-datepicker-prev">' +
      '<i class="fn-datepicker-prev-icon"></i></th>' +
      '<th colspan="5" class="fn-datepicker-switch">' +
      '<div class="fn-datepicker-select"></div></th>' +
      '<th class="fn-datepicker-next"><i class="fn-datepicker-next-icon"></i>' +
      '</th></tr></thead>',

      contTemplate: '<tbody><tr><td colspan="7"></td></tr></tbody>'
    };

    DPGlobal.template = '<div class="fn-datepicker fn-datepicker-dropdown">' +
    '<div class="fn-datepicker-caret"></div>' +
    '<div class="fn-datepicker-days">' +
    '<table class="fn-datepicker-table">' +
    DPGlobal.headTemplate +
    '<tbody></tbody>' +
    '</table>' +
    '</div>' +
    '<div class="fn-datepicker-months">' +
    '<table class="fn-datepicker-table">' +
    DPGlobal.headTemplate +
    DPGlobal.contTemplate +
    '</table>' +
    '</div>' +
    '<div class="fn-datepicker-years">' +
    '<table class="fn-datepicker-table">' +
    DPGlobal.headTemplate +
    DPGlobal.contTemplate +
    '</table>' +
...
define('fnui/dropdown',['jquery','./fnuicore'],function($,UI){
...
define('fnui/modal',['jquery','./fnuicore','./dimmer'],function($,UI){
...
define('fnui/hammer',['jquery'],function($){
...
define('fnui/offcanvas',['jquery','./fnuicore','./hammer'],function($,UI){
...
/*=============
  FNUI 2.0 DATEPICKER
================*/
define('fnui/popover',['jquery','./fnuicore'],function($,UI){
...
define('fnui/progress',['./fnuicore'],function(UI){
...
define('fnui/pinchzoom',['jquery'],function($){
...
define('fnui/pureview',['jquery','./fnuicore','./pinchzoom','./hammer'],function($,UI,PinchZoom,Hammer){
...
define('fnui/scrollspy',['jquery','./fnuicore'],function($,UI){
...
define('fnui/scrollspynav',['jquery','./fnuicore'],function($,UI){
...
define('fnui/select',['jquery','./fnuicore','./dropdown'],function($,UI){
...
define('fnui/slider',['jquery','./fnuicore'],function($,UI){
...
define('fnui/smoothscroll',['jquery','./fnuicore'],function($,UI){
...
// Init code
$(document).on('click.smoothScroll.data-api', '[data-fn-smooth-scroll]',
  function(e) {
    e.preventDefault();
...
define('fnui/sticky',['jquery','./fnuicore'],function($,UI){
...
define('fnui/tabs',['jquery','./fnuicore'],function($,UI){
...
================*/
 ...
 define('fnui/ucheck',['jquery','./fnuicore'],function($,UI){
...
define('fnui/validator',['jquery','./fnuicore'],function($,UI){
    ...
    if (options.validateOnSubmit) {
      ...
      if ($element.data('fnui.checked')) {
        ...
        $.when(formValidity).then(function() {
          ...
          // fail
          $element.data('fnui.checked', false).
...
Validator.prototype.removeMark = function() {
  this.$element
    .find('.fn-form-success, .fn-form-error, .' + this.options.inValidClass +
...
Validator.prototype.destroy = function() {
  ...
  this.$element.removeData('fnui.validator fnui.checked')
    .off('.validator')
    .find(this.options.allFields).removeData('validity fnui.dfdValidity');
};
...
define('fnui/switch',['jquery','./fnuicore'],function($,UI){	  
...
/*=============
  FNUI 2.0 TOAST
================*/
define('fnui/toast',['jquery','./fnuicore'],function($,UI){
...
define('fnui',['fnui/fnuicore','fnui/dimmer','fnui/alert','fnui/button','fnui/collapse',
        "fnui/datepicker",'fnui/dropdown','fnui/modal','fnui/offcanvas',
        'fnui/popover','fnui/progress','fnui/pureview','fnui/scrollspy',
        'fnui/scrollspynav','fnui/select','fnui/slider','fnui/smoothscroll', 
        "fnui/sticky",'fnui/tabs',"fnui/ucheck","fnui/validator",'fnui/switch',
        'fnui/toast'
        ],function(FNUI){
